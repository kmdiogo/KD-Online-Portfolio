<template>
    <div class="text-page d-flex flex-column">
        ...
        <p class="m-0">
            Given a list of tokens, this program will generate a C++ Lexical Analyzer class. The DFA that drives the Lexical Analyzer is generated by first
            creating an NFA using <a href="https://en.wikipedia.org/wiki/Thompson%27s_construction">Thompson's Construction Algorithm</a>
            then converting that NFA to a DFA using <a href="https://en.wikipedia.org/wiki/Powerset_construction">Powerset Construction</a>
